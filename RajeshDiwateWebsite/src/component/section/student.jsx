...
const studentList = [
  {
    ...
    href: "https://simplifyhealthcare.com/",
    desc: "Developed scalable React.js applications within an Nx monorepo using Micro Frontend (MFE) architecture, integrated RESTful APIs and dynamic insurance rule workflows to improve healthcare documentation efficiency, data consistency, application functionality, and overall user experience.",
  },

  {
    ...
    degi: "Pune , India",
    durasion: "(Jul 2023 - Jan 2026)",
    href: "https://juno.org.in/",
    desc: "Developed and maintained web applications using the MERN stack, ensuring project requirements and deadlines were met. Collaborated with cross-functional teams to design and implement new features with seamless integration into existing systems. Built responsive and user-friendly interfaces using React.js and Redux. Designed and optimized database schemas to improve performance and scalability. Conducted code reviews and provided constructive feedback to maintain code quality and best practices. Worked closely with clients to gather requirements, provide technical guidance, and resolve issues effectively. Actively participated in Agile ceremonies including sprint planning, daily stand-ups, and retrospectives.",
  },
  {
    imgUrl: "",
    imgAlt: "Tech Prime Lab.",
    name: "Tech Prime Lba",
    degi: "Pune , India",
    durasion: "(Mar 2023 - May 2023)",
    href: "",
    desc: "Designed and implemented scalable, responsive, and visually engaging user interfaces to enhance application functionality, usability, and overall user experience.",
  },
  {
