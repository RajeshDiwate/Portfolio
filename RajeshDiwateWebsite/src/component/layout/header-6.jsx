...
const HeaderSix = () => {
  ...
  return (
    <Fragment>
      <header
        className={`header-section style-4 style-6 ${headerFiexd ? "header-fixed fadeInUp" : ""}`}
      >
            ...
            <div className="header-top-area">
              <div className="header-top-contact">
                <a href="tel:+880123456789">
                  <i className="icofont-phone"></i> +880 123 456 789
                </a>
                <a href="mailto:contact@yourmail.com">
                  <i className="icofont-envelope"></i> contact@yourmail.com
                </a>
              </div>
